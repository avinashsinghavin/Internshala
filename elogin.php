<?php
  ...
  if(isset($_POST["submit"])) {
    ...
    $userid=$_POST["email"];
    $password=$_POST["pwd"];
    $result=mysqli_query($connection,"SELECT * from login where Email_id='$userid' and Password='$password';");
    ...
    if($data) { 
      ...
      }else{ ?> <script type='text/javascript'>alert('Invalid Userid / Password');</script><?php }
    }
    else{ ?> <script type='text/javascript'>alert('Invalid Userid / Password');</script><?php }
  }
?>
...
<!-- Header End -->
 ...
 <!-- Middle Login Page -->
    <div class="container col-4" style="background: white; padding: 10px;">
      ...
      <form class="form-horizontal" action="./elogin.php" method=post>
        ...
        <div class="form-group">        
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" name="submit"class="btn btn-default" style="background: skyblue;">LOGIN</button>
          </div>
        </div>
      </form>
    </div>
...
<br>
  ...
  <footer class="page-footer font-small blue pt-4 bg-dark text-white">
    ...
    <div class="footer-copyright text-center py-3" style="text-align-last: right; padding-right: 5%;">
      <a href="index.html" style="color: white;">© Copyright 2019 Internshala</a>
    </div>
  </footer>
<!-- footer end -->
<!-- PHP -->
